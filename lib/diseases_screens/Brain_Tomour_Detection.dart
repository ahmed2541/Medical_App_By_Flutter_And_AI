...
class BrainTomourDetection extends StatefulWidget {
  const BrainTomourDetection({super.key});

  @override
  State<BrainTomourDetection> createState() => _BrainTomourDetectionState();
}

class _BrainTomourDetectionState extends State<BrainTomourDetection> {
